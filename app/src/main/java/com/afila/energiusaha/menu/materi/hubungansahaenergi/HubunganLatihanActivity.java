...
public class HubunganLatihanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hubungan_latihan);
        ...
        toolbarback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HubunganLatihanActivity.this.finish();
            }
        });
        ...
        btna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HubunganLatihanActivity.this, HubunganLatihanActivity2.class);
                soal1 = "a";
        ...
        btne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HubunganLatihanActivity.this, EnergiLatihanActivity2.class);
                soal1 = "e";
                Preferences.setSoal1(getBaseContext(),soal1);
                startActivity(intent);
                HubunganLatihanActivity.this.finish();
