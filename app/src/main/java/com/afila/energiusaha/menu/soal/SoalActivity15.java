...
public class SoalActivity15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvToolbarSoal.setText("Soal Tes 15");

        toolbarback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SoalActivity15.this.finish();
            }
        });
        ...
        btna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SoalActivity15.this, SoalActivity16.class);
                soal15 = "a";
                Preferences.setSoal15(getBaseContext(),soal15);
