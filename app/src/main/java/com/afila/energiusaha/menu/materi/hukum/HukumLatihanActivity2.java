...
public class HukumLatihanActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hukum_latihan2);
        ...
        tvToolbarSoal.setText("Latihan-Hukum 2");

        toolbarback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                HukumLatihanActivity2.this.finish();
            }
        });
        ...
        btna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HukumLatihanActivity2.this, ResultActivityHukum.class);
                soal2 = "a";
