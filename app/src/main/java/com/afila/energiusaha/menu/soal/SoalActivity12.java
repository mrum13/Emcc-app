...
public class SoalActivity12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvToolbarSoal.setText("Soal Tes 12");

        toolbarback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SoalActivity12.this.finish();
            }
        });
        ...
        btna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SoalActivity12.this, SoalActivity13.class);
                soal12 = "a";
                Preferences.setSoal12(getBaseContext(),soal12);
