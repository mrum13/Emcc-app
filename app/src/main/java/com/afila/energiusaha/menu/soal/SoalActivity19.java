...
public class SoalActivity19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvToolbarSoal.setText("Soal Tes 19");

        toolbarback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SoalActivity19.this.finish();
            }
        });
        ...
        btna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SoalActivity19.this, SoalActivity20.class);
                soal19 = "a";
                Preferences.setSoal19(getBaseContext(),soal19);
