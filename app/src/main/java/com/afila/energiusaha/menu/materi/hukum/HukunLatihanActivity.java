...
public class HukunLatihanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hukun_latihan);
        ...
        toolbarback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HukunLatihanActivity.this.finish();
            }
        });
        ...
        btna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HukunLatihanActivity.this, HukumLatihanActivity2.class);
                soal1 = "a";
