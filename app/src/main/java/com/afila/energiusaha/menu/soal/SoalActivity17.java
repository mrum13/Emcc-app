...
public class SoalActivity17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvToolbarSoal.setText("Soal Tes 17");

        toolbarback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SoalActivity17.this.finish();
            }
        });
        ...
        btna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SoalActivity17.this, SoalActivity18.class);
                soal17 = "a";
                Preferences.setSoal17(getBaseContext(),soal17);
